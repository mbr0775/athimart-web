...
import { createProduct } from "@/app/(seller)/seller/products/new/actions";
        ...
        <div className="space-y-7">
          ...
          <section className="border border-[var(--border)] bg-white p-5 sm:p-7">
            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2">
              ...
              {/* Company */}
              <label data-product-field="companyName">
                <RequiredLabel>
                  Company /
                  Seller
                </RequiredLabel>
              ...
              {/* Subcategory */}
              <label data-product-field="subCategory">
                <RequiredLabel>
                  Product type
                </RequiredLabel>
        ...
        <div className="space-y-7">
          ...
          <section className="border border-[var(--border)] bg-white p-5 sm:p-7">
            ...
            <div className="mt-6 space-y-6">
              {/* Selling price */}
              <label data-product-field="priceLkr">
                <RequiredLabel>
                  Selling price
                  — LKR
                </RequiredLabel>
              ...
              {/* Stock */}
              <label data-product-field="stock">
                <RequiredLabel>
                  Available stock
                </RequiredLabel>
